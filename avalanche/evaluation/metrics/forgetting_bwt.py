...
# from avalanche.evaluation.metrics import MeanAbsoluteError

# class MAEForgetting(GenericExperienceForgetting[MeanAbsoluteError, float, float]):
#     """
#     MAE-based Forgetting Metric for regression tasks.
#     """

#     def __init__(self):
#         # Initialize the parent class with MAE as the base metric.
#         super().__init__(current_metric=MeanAbsoluteError())

#     def metric_update(self, strategy):
#         """
#         Update the current metric (MAE) using the strategy object.
#         """
#         # Update the MAE metric using the predictions and targets from the strategy
#         self._current_metric.update(strategy.mb_output, strategy.mb_y)

#     def metric_result(self, strategy):
#         """
#         Return the current value of the MAE metric.
#         """
#         # Return the computed MAE
#         return self._current_metric.result()

#     def result_key(self, k: int) -> float:
#         """
#         Return the forgetting value for the specified experience (k).
#         """
#         # Return the forgetting for experience k
#         return self.forgetting.result_key(k)

#     def result(self) -> float:
#         """
#         Return the forgetting value for all experiences.
#         """
#         return self.forgetting.result()

#     def __str__(self):
#         """
#         Provide a string representation of the metric.
#         """
#         return "MAEForgetting"
...
# class ExperienceForgettingWithPrint(ExperienceForgetting):
#     def result(self):
#         print("Calculating forgetting result...")
#         print('ik', self.forgetting.initial.keys())
#         print('lk', self.forgetting.last.keys())
#         return super().result()
