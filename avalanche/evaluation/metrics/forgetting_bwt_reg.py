...
from avalanche.evaluation.metrics import TaskAwareAccuracy, MeanAbsoluteError, TaskAwareMeanAbsoluteError, Mean
...
class ExperienceForgetting(
    GenericExperienceForgetting[TaskAwareMeanAbsoluteError, Dict[int, float], Optional[float]]
):
    """
    ...
    def __init__(self):
        ...
        super().__init__(TaskAwareMeanAbsoluteError())
...
class StreamForgetting(GenericStreamForgetting[TaskAwareMeanAbsoluteError]):
    """
