...
class RegressionMatrixPluginMetric(PluginMetric[float]):
    """
    ...
    def __init__(self):
        ...
        super(RegressionMatrixPluginMetric, self).__init__()
...
def regression_matrix_metrics() -> List[PluginMetric]:
    """
    Helper method that can be used to obtain the desired set of
    plugin metrics.
