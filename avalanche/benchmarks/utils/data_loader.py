...
class GroupBalancedDataLoader(SingleDatasetDataLoader):
...
def _make_data_loader(
    ...
    if DistributedHelper.is_distributed and distributed_sampling:
        ...
        drop_last = data_loader_args.pop("drop_last", True)
...
def _make_data_loader_with_batched_sampler(
    ...
    data_loader_args = data_loader_args.copy()
    # print('MAKE BATCH SAMPLER DATALOADER *********************')
    ...
    data_loader_args.pop("drop_last", True)
