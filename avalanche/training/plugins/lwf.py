from avalanche.training import LearningWithoutForgettingRAADL, LearningWithoutForgetting
...
class LwFPluginRAADL(SupervisedPlugin):
    """Learning without Forgetting plugin.
    ...
    def __init__(self, alpha=1, temperature=2):
        ...
        """
        super().__init__()
        self.lwf = LearningWithoutForgettingRAADL(alpha, temperature)
    ...
    def before_backward(self, strategy, **kwargs):
        ...
        strategy.loss += self.lwf(strategy.mb_x, strategy.mb_f, strategy.mb_output, strategy.model)
