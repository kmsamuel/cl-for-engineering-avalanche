...
from avalanche.evaluation.metrics import accuracy_metrics, loss_metrics, regression_metrics
...
def default_evaluator() -> EvaluationPlugin:
    return EvaluationPlugin(
        ...
        regression_metrics(minibatch=False, epoch=True, experience=True, stream=True),
